    ...
    <div class="login-container">
        ...
        <div class="login-content">
            ...
            <form id="Form1" runat="server">
                ...
                <div class="form-group">
                    <asp:Button class="btn btn-primary btn-block" ID="btnforgotpassword" runat="server" Text="Recover Password" />
                </div>
                <p class="text-center"><a href="Login.aspx">Back to Login</a></p>
            </form>
        </div>
    </div>
    <!--Load JQuery-->
